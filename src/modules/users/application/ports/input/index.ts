/**
 * Barrel export para input ports de la capa de aplicación
 */
export type { ICreateUserUseCase } from './ICreateUserUseCase';
...
export type { IListUsersUseCase } from './IListUsersUseCase';
export type { IDeleteUserUseCase } from './IDeleteUserUseCase';
