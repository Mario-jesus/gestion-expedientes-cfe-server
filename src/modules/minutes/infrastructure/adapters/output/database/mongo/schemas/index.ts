/**
 * Barrel export para todos los esquemas/modelos de Mongoose del módulo minutes
 * 
...
// ============================================
// ESQUEMAS/MODELOS DEL MÓDULO MINUTES
// ============================================
...
export { MinuteModel, type MinuteMongo } from './MinuteSchema';
