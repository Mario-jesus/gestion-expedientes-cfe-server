...
import { ITokenVerifier, TokenExpiredError, InvalidTokenError } from './types';

/**
 * Middleware de autenticación que verifica y valida tokens JWT
 * 
 * Extrae el token del header Authorization (Bearer token)
 * Verifica el token usando un verificador de tokens genérico
 ...
 * que requiera autenticación HTTP. No depende de implementaciones específicas.
 * 
 * @param tokenVerifier - Servicio que puede verificar tokens (debe implementar ITokenVerifier)
 * @param logger - Logger para registrar eventos
 */
export function authenticate(tokenVerifier: ITokenVerifier, logger: ILogger) {
