...
```typescript
import { resolve } from '@/shared/infrastructure';
import { MongoDBDatabase } from '@/shared/infrastructure/adapters/output/database/mongo/MongoDBDatabase';
...
```typescript
import { connectMongoose, disconnectMongoose, getConnection } from '@/shared/infrastructure/adapters/output/database/mongo/mongoose';
...
```typescript
import { InMemoryDatabase } from '@/shared/infrastructure/adapters/output/database/InMemoryDatabase';
